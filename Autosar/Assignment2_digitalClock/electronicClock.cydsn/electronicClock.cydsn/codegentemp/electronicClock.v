...
module top ;
    ...
    assign Net_666 = Net_665 | Net_664;
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .rx_clk(Net_1850),
        .rx_data(Net_1851),
        .rx_interrupt(Net_1852),
        .tx(Net_1844),
        .tx_clk(Net_1853),
        .tx_data(Net_1854),
        .tx_en(Net_1855),
        .tx_interrupt(Net_1856));
    ...
    ADC_SAR_SEQ_v2_10_6 JOYSTICK_ADC_XY (
        .aclk(1'b0),
        .AIN_10(Net_646),
        .AIN_100(Net_1901),
        .AIN_101(Net_1902),
    ...
    SPI_Master_v2_50_7 TFT_SPI (
        .clock(1'b0),
        .miso(Net_1999),
        .mosi(wTFT_SDA),
        .reset(1'b0),
        .rx_interrupt(Net_2001),
        .sclk(wTFT_SCL),
        .sdat(Net_2002),
        .ss(Net_2003),
        .tx_interrupt(Net_2004));
    ...
    assign Net_1999 = 1'h0;

    assign Net_2005 = 1'h0;
