// ======================================================================
// autosar_01.v generated from TopDesign.cysch
// 06/01/2022 at 14:00
...
module ADC_SAR_SEQ_v2_10_1 (
	...
	cy_clock_v1_0
		#(.id("e3b288a5-f1d5-4265-908b-79133e404a0e/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("e3b288a5-f1d5-4265-908b-79133e404a0e/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("27044bc9-f56e-4d3c-8d7d-e89735b94454"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Green_RGB_net;
	wire [0:0] tmpFB_0__Green_RGB_net;
	wire [0:0] tmpIO_0__Green_RGB_net;
	wire [0:0] tmpINTERRUPT_0__Green_RGB_net;
	electrical [0:0] tmpSIOVREF__Green_RGB_net;

	cy_psoc3_pins_v1_10
		#(.id("a27b3115-34a7-448a-b61e-3405bf919c4e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Green_RGB
		 (.oe(tmpOE__Green_RGB_net),
		  .y({Net_1609}),
		  .fb({tmpFB_0__Green_RGB_net[0:0]}),
		  .io({tmpIO_0__Green_RGB_net[0:0]}),
		  .siovref(tmpSIOVREF__Green_RGB_net),
		  .interrupt({tmpINTERRUPT_0__Green_RGB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Green_RGB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("83f94714-55af-44e0-a722-69e84a790211"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a7744ab1-1e8f-428b-a6a2-a132be167f27"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_2 PWM_Green (
        ...
        .tc(Net_598),
        .trigger(1'b0));
    defparam PWM_Green.Resolution = 8;

	wire [0:0] tmpOE__button_osShutdown_net;
	wire [0:0] tmpIO_0__button_osShutdown_net;
	wire [0:0] tmpINTERRUPT_0__button_osShutdown_net;
	electrical [0:0] tmpSIOVREF__button_osShutdown_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		button_osShutdown
		 (.oe(tmpOE__button_osShutdown_net),
		  .y({1'b0}),
		  .fb({Net_626}),
		  .io({tmpIO_0__button_osShutdown_net[0:0]}),
		  .siovref(tmpSIOVREF__button_osShutdown_net),
		  .interrupt({tmpINTERRUPT_0__button_osShutdown_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__button_osShutdown_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_3 UART_1 (
        ...
        .rx_clk(Net_619),
        .rx_data(Net_620),
        .rx_interrupt(Net_621),
        .tx(Net_610),
        .tx_clk(Net_622),
        .tx_data(Net_623),
        .tx_en(Net_624),
        .tx_interrupt(Net_625));
	...
	wire [0:0] tmpOE__led_y_net;
	wire [0:0] tmpFB_0__led_y_net;
	wire [0:0] tmpIO_0__led_y_net;
	wire [0:0] tmpINTERRUPT_0__led_y_net;
	electrical [0:0] tmpSIOVREF__led_y_net;
	...
	cy_psoc3_pins_v1_10
		...
		led_y
		 (.oe(tmpOE__led_y_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__led_y_net[0:0]}),
		  .io({tmpIO_0__led_y_net[0:0]}),
		  .siovref(tmpSIOVREF__led_y_net),
		  .interrupt({tmpINTERRUPT_0__led_y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__led_y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
