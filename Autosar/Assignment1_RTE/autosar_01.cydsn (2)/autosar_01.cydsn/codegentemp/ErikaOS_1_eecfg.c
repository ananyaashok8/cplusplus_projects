 ...
 **************************************************************************/
    ...
    #define TASK_1_STACK_SIZE 8192/4 // size = 8192 bytes
    int EE_cortex_mx_stack_1[TASK_1_STACK_SIZE];	/* Task 1 (tsk_init) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 1))
    #define TASK_2_STACK_SIZE 1000/4 // size = 1000 bytes
    ...
    #define TASK_6_STACK_SIZE 1000/4 // size = 1000 bytes
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (tsk_testcase) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_testcase*/
        #endif
        #ifdef TASK_7_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 5
        ,&EE_oo_thread_stub      /* thread tsk_testcase */
    #endif
    #if EE_MAX_TASK > 6
 ...
 **************************************************************************/
    ...
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        #if EE_MAX_ALARM > 0
        {0, alarm_10ms, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 1
        ,{0, alarm_1ms, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 2
        ,{0, alarm_25ms, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 3
        ,{0, Alarm_4, EE_ALARM }
        #endif
