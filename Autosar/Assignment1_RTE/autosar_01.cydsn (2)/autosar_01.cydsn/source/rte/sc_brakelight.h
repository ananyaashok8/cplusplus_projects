 ...
 * @param const sc_brakelight_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_BRAKELIGHT_init( SC_BRAKELIGHT_t * const signal, const SC_BRAKELIGHT_data_t * const value )
{                                                                                                                      
