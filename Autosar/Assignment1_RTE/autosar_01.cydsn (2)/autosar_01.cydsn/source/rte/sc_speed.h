 ...
 * @param const sc_speed_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_SPEED_init( SC_SPEED_t * const signal, const SC_SPEED_data_t * const value )
{                                                                                                                      
